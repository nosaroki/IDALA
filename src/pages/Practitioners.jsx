...
const PRACTS = [
  ...
  { icon: 'Osteopathy',  slug: 'osteopathy', titleFr: 'Ostéopathie',           titleEn: 'Osteopathy',          category: 'corps',   chakra: 'c4', fr: "Une thérapie manuelle centrée sur la structure du corps (muscles, articulations, squelette) pour relâcher les tensions, améliorer la mobilité et soutenir la capacité naturelle du corps à s'autoréguler.", en: "A manual therapy focused on the body's structure (muscles, joints, skeleton) to release tension, improve mobility and support the body's natural capacity to self-regulate." },
